...
<div class="woocommerce-variation-add-to-cart variations_button">
	...
	<div class="relative px-[5px] w-8">
		...
		<div class="plus-button absolute top-1/2 transform -translate-y-1/2 w-2 h-2 bg-one border-1 right-0 cursor-pointer">
...
// }
	...
	<button type="submit" class="text-16 leading-16 block py-1.5 px-3 bg-three border-2 border-three transition-colors text-white w-fit"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
