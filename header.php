         ...
         <div class="bg-three w-screen block md:hidden">
            <div class="flex justify-between items-center py-1 container">
                <div class="col-span-1 flex items-center">
                    ...
                    <a href="/" class="text-30 font-titel text-white">nutridog.nl</a>
                </div>
            ...
            <div class="flex justify-between items-center pb-2 md:pb-0 h-5 md:h-8 container">
                ...
                <div class="col-span-1 hidden md:flex justify-end">
                    <div class="flex">
                        ...
                        <a href="/checkout" class="relative">
                            <span class="absolute top-[-7px] right-[-7px] h-[15px] w-[15px] bg-geel rounded-full flex justify-center items-center"><p class="text-white text-10 leading-10" data-no-cache="true"><?php echo WC()->cart->get_cart_contents_count(); ?></p></span>
